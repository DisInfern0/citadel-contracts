...
contract Drakma is Context, AccessControlEnumerable, ERC20Capped, ERC20Burnable, ERC20Pausable, ReentrancyGuard {
    ...
    function pause() external virtual {
        require(hasRole(DEV_ROLE, _msgSender()), "drakma: must have dev role to pause");
        _pause();
    }

    function unpause() external virtual {
        require(hasRole(DEV_ROLE, _msgSender()), "drakma: must have dev role to unpause");
        _unpause();
    }
